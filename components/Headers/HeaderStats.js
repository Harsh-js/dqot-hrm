				...
				<div className='px-4 md:px-10 mx-auto w-full'>
					...
					<div>
						...
						<div className='flex flex-wrap'>
							<ul class="flex flex-col w-full px-4 mb-5  lg:flex-row list-none ml-auto mobile-btn"><li class="nav-item"><a class="px-4 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75 bg-red-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-3 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"><i class="far fa-clock mr-2"></i>Time Card</a></li><li class="nav-item"><a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75 bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-3 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"><i class="far fa-clock mr-2"></i>Check/Check in Out</a></li></ul>
